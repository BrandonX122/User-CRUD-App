...
import { editUser, State } from "@/lib/action";
...
export default function EditForm({
  ...
  const [state, formAction] = useActionState(editUserById, initialState);
          ...
          <div className="grid grid-cols-3 gap-4">
            <Field>
              ...
              <select
                id="month"
                name="month"
                defaultValue={String(bday.getMonth() + 1).padStart(2, "0")}
              >
                <option value="" hidden>
                  MM
                </option>
            ...
            <Field>
              ...
              <select
                name="day"
                id="day"
                defaultValue={String(bday.getDate()).padStart(2, "0")}
              >
                <option value="" hidden>
                  DD
                </option>
            ...
            <Field>
              ...
              <select id="year" name="year" defaultValue={bday.getFullYear()}>
                <option value="" hidden>
                  YYYY
                </option>
                {Array.from(
